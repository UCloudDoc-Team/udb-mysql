...
UDB数据库提供内存、硬盘等配置供用户选择；SSD机型及标准机型单个数据库实例默认核数（C）与内存（G）比为1:4，核数向上取整。NVMe机型实例CPU核数与内存对应关系如下：
| 内存GB | 2 | 4 | 8 | 12 | 16 | 24 | 32 | 48 | 64 | 96 | 128 | 192 | 256 | 320 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| CPU核数  |  4  | 6 | 8 | 12 | 12 | 12 | 16 | 16 | 24 | 24 | 32 | 32 | 48 | 48 |
